...
\citet{gomez2007weather} show that rain on election day suppresses voter turnout with differential effects by party. This is relevant for the turnout channel: my positive turnout coefficient could be in tension with their finding if smoke operated like bad weather, but smoke exposure in my specification is measured over the pre-election window rather than on election day itself, and the positive sign indicates mobilization rather than suppression.
